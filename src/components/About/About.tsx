    ...
    <div id="about" className="w-full scroll-mt-15 px-[12%] py-8">
      ...
      <div className="flex w-full flex-col md:flex-row items-start lg:items-center gap-20 my-12">
        <div className="flex-1">
          ...
          >
            توسعه دهنده فرانت اند با دو سال تجربه در طراحی و پیاده سازی رابط های
            کاربری واکنش گرا و مدرن. متخصص در تبدیل ایده ها و طرح ها به وب سایت
            های کاربر پسند و متعهد به تحویل به موقع پروژه هاآشنا با تکنولوژی های
            روز و ابزار های مدرن توسعه وب با تمرکز بر بهینه سازی تجربه کاربری و
            عملکرد سایت.
          </motion.p>
